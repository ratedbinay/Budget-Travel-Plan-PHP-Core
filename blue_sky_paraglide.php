...
<html>
<head>
  <title>Blue Sky Paraglide</title>
  <meta charset="utf-8">
...
<div class="blue-sky">
        <div class="row">
          <div class="col-sm-6">
            <img src="images/blueskyparaglide.jpg" style="width: 100%; height: 400px;">
          </div>
          <div class="col-sm-6">
            <h1>WELCOME TO BLUE SKY PARAGLIDING NEPAL</h1>
    ...
    <form method="POST">
      <div class="dropdown">
                  ...
                  <div class="dropdown-content">
                    <a><input type="radio" name="radio" value="5000">Normal - NRs 5000</a>
                    <a><input type="radio" name="radio" value="6000">With pickup/drop service - NRs 6000 </a>
                    
                  </div>

                </div>
        <a href="http://booking.paragliding-nepal.com/en_GB/tours/45325" name="bookhere" class="btn btn-lg btn-book">Book</a>           
...
$placee="Pokhara";
$recreationn="Blue Sky Paraglide";
