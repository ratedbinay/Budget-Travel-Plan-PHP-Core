...
<section>
  <div class="container">
       ...
       <div class="blue-sky">
        <div class="row">
          <div class="col-sm-8">
            <img src="images/hotel green park 1.jpg" style="width: 100%; height: 400px;">
          </div>
          <div class="col-sm-4">
            <h2>WELCOME TO Hotel Green Park</h2>
              <p>We borrowed the cool from the breeze that plays along with tall elephant grasses that grow in the wilderness just outside our traditionally carved entrance doors. We borrowed the warm hospitality from the ethnics that has made Baghmara ever such a wonderful place to visit in chitwan. We went into the deep heart of the jungle, and borrowed the songs of the flowers and stories of the trees and then painted them in our rooms, with each room getting a different song, a different story.Green Park Chitwan is the best luxury resort in chitwan with its traditional touches with luxurious appurtenance and a homely atmosphere</p>
...
<div class="button">
    <form method="POST">
      <div class="dropdown">
        ...
        <a href="https://www.booking.com/hotel/np/green-park-chitwan.en-gb.html?aid=357026;label=gog235jc-1DCAsoqwFCEmdyZWVuLXBhcmstY2hpdHdhbkgzWANoqwGIAQGYAQm4AQjIAQzYAQPoAQGIAgGoAgM;sid=4c07de71f60debd7638895c80895ee59;dist=0&keep_landing=1&sb_price_type=total&type=total&" name="bookhere" class="btn btn-lg btn-book">Book</a>           
